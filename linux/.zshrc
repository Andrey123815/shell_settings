...
# Функция для игнорирования нажатия Enter
function ignore_enter() {
  return 0
}

# Функция для привязки клавиши Enter в зависимости от команды
...
# Установить начальную привязку клавиш
bind_enter_key

# Добавить вызов bind_enter_key к событию zle-line-finish
